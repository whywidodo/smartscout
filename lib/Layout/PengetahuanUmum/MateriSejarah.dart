...
import 'package:smartscout/Layout/PengetahuanUmum/DownloadSejarah.dart';
    ...
    return Scaffold(
          ...
          Padding(
            ...
            onPressed: () async {
              if(statusPlay == false){
                ...
                await player.play(AssetSource('audio/pengetahuan/sejarah.mp3'));
              }else{
                setState(() {
                  statusPlay = !statusPlay;
                });
      ...
      floatingActionButton: FloatingActionButton(
        ...
        onPressed: (){
          showDialog(
            context: context,
            builder: (context) => const DownloadSejarah(),
          );
        },
      ),
